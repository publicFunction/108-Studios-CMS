...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_LOGIN_PASSWORD', 'bubblefish');
	...
	//FILESYSTEM CONFIG
		...
		*/
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../include/uploads/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../include/uploads/');	//accept relative path only
